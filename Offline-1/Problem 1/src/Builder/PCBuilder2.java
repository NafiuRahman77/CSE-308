...
public class PCBuilder2 implements Builder{
    ...
    public void addBase() {
        ...
        Parts liquidCooler=new LiquidCooler();
        pc.addParts(liquidCooler);
        pc.addBase(liquidCooler);
